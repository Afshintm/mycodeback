...
namespace Essence.Communication.Models.Dtos
{
    ...
    //event code 156
    public class EmergencyPanicAlarmDetails: BaseDetails
    {      
    }

    //2105
    public class NoPresenceDetails : BaseDetails
    {
        public PeriodObject Period { get; set; }
    }

    //113
    public class HotTemperatureAlarmDetails: BaseDetails
    {
    ...
    //206
    public class LowBatteryRestoreDetails: BaseDetails
    {
