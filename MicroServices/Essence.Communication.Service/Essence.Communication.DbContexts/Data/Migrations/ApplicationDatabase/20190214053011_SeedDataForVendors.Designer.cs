...
namespace Essence.Communication.DbContexts.Data.Migrations.ApplicationDatabase
{
    ...
    [Migration("20190214053011_SeedDataForVendors")]
    partial class SeedDataForVendors
    {
            ...
            modelBuilder.Entity("Essence.Communication.Models.AccountGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "422cddc9-8363-44fd-98b0-01c685a923f4",
                            CreatedDate = new DateTime(2019, 2, 14, 5, 30, 10, 955, DateTimeKind.Utc).AddTicks(2519),
                            Name = "TestGroup"
                        });
                });
            ...
            modelBuilder.Entity("Essence.Communication.Models.Dtos.EssenceEventObjectStructure", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 14, 5, 30, 10, 912, DateTimeKind.Utc).AddTicks(3603));
            ...
            modelBuilder.Entity("Essence.Communication.Models.Vendor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "21268423-2d32-417e-9c3b-bd7ad607834d",
                            CreatedDate = new DateTime(2019, 2, 14, 5, 30, 10, 953, DateTimeKind.Utc).AddTicks(5318),
                            Name = "Essence"
                        });
                });
