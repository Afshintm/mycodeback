...
namespace Essence.Communication.DbContexts.Data.Migrations.ApplicationDatabase
{
    ...
    [Migration("20190213000227_RemoveVendorFromHscEvent")]
    partial class RemoveVendorFromHscEvent
    {
            ...
            modelBuilder.Entity("Essence.Communication.Models.Dtos.EssenceEventObjectStructure", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 13, 0, 2, 26, 573, DateTimeKind.Utc).AddTicks(3571));
